...
After the last talk we need to do the following:

- test if we can *filter* data and remove noisy images
- need to be better able to estimate the number of clusters
        * subsample 1e4, 1e5, 1e6 cells and extrapolate from that
        * find another better way
        * add the new approaches to `koios`
- maybe only work on the bartonella data

Literature:

- look at work of mahony from stanford
- read newest pelkmans/gut paper from science
- compile other approaches people have done before on clustering and big data -> compile a good list

Characterisation:

- characterize clusters
- which perturbations induce same phenotype
- which perturbation + pathogen combinations induce same phenotype

Nonsense. What a waste of resources and time.
