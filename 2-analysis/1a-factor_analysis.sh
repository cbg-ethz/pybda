...
#/cluster/home/simondi/spark/bin/spark-submit  --master $1  --num-executors 10 --executor-cores 1 --total-executor-cores 10 01-fa_spark.py -o /cluster/home/simondi/simondi/results/kmeans_fa/all_optimal_from_file_feature_dbq_250_cells_100 -f /cluster/work/bewi/members/simondi/data/tix/query_data/all_test.tsv
